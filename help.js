function init() {
  ...
  myDiagram.addDiagramListener("LinkDrawn", function(e) {
    ...
    //Не нужно для работы, зачем я тут это написал? Удалить на мидлрелизе
  ...
  var nodeMenu =  
    $("ContextMenu",
      ...
      /*makeButton("Add bottom port",
        function(e, obj) { addPort("bottom"); }),*/
      makeButton("Написать функцию",
        function(e, obj) { showEditeFrame() })
    );
    ...
    $("ContextMenu",
      ...
      makeButton("Добавить",
        function(e, obj) {
          ...
          let node = {name:"New Func", leftArray:[], topArray:[], bottomArray:[], rightArray:[]};
...
CustomLink.prototype.computeEndSegmentLength = function(node, port, spot, from) {
  ...
  if (port !== null && other !== null) {
    ...
    console.log(spot.y);
    console.log(from);
    var thispt = port.getDocumentPoint(sp);
